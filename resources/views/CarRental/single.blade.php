      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            <img src="{{asset('upload/'. $car->image)}}" alt="" class="img-fluid p-3 mb-5 bg-white rounded">
...
<li><a href="#">{{$category1->categoryName}}  <span>({{$car->where('category_id', $category1->id)->count()}})</span></a></li>
@endforeach 
      ...
      <footer class="site-footer">
        <div class="container">
          ...
          <a href="https://github.com/khforever" target="_blank" >Kholoud Mohamed Hafez</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
              </div>
            </div>
